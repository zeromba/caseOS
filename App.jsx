...
// ── STORAGE ───────────────────────────────────────────────────────────────
const storage = {
  async get(key) { try { return await window.storage.get(key); } catch { return null; } },
  async set(key, value) { try { return await window.storage.set(key, JSON.stringify(value)); } catch { return null; } },
  async list(prefix) { try { return await window.storage.list(prefix); } catch { return { keys: [] }; } },
};
